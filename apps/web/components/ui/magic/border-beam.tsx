...
export function BorderBeam({
  ...
  return (
    ...
    >
      <span
        className="absolute left-1/2 top-1/2 aspect-square w-[200%] -translate-x-1/2 -translate-y-1/2 animate-[beam-spin_var(--beam-duration)_linear_infinite] bg-[conic-gradient(from_0deg,transparent_0deg,transparent_300deg,rgba(103,232,249,0.9)_345deg,rgba(255,255,255,0.95)_360deg)]"
        style={
