...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default:
          "bg-cyan-300 text-slate-950 shadow-[0_0_0_0_rgba(103,232,249,0)] hover:bg-cyan-200 hover:shadow-[0_8px_30px_-8px_rgba(103,232,249,0.55)]",
        secondary:
          "bg-white/10 text-white hover:bg-white/15",
        outline:
          "border border-white/15 text-white hover:border-cyan-300/60 hover:bg-white/5",
        ghost: "text-slate-300 hover:bg-white/5 hover:text-cyan-200",
        destructive:
          "bg-rose-400/15 text-rose-100 ring-1 ring-inset ring-rose-400/30 hover:bg-rose-400/25",
        warning:
          "bg-amber-300 text-slate-950 hover:bg-amber-200",
        link: "h-auto min-h-0 rounded-none px-0 text-cyan-300 underline-offset-4 hover:underline active:scale-100",
      },
      size: {
